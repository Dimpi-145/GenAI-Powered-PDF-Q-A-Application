  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col min-h-0 overflow-y-auto pb-28">
        ...
        <button className='flex items-center justify-center w-full p-3 mt-2 mx-auto text-white bg-gradient-to-r from-[#A456F7] to-[#3D81F6] text-base rounded-lg shadow-md cursor-pointer'>
...
const Sidebar = ({isMenuOpen, setIsMenuOpen}) => {
  ...
  return (
    <div
      className={`flex flex-col h-screen min-w-72 p-1 dark:bg-gradient-to-b from-[#242124]/30 to-[#00000]/30 border-r border-[#80609F]/30 backdrop-blur-3xl transition-all duration-500 overflow-y-auto
        max-md:fixed max-md:top-0 max-md:left-0 max-md:w-full max-md:h-full max-md:z-50
        ${theme === 'dark' ? 'max-md:bg-[#242124]/95' : 'max-md:bg-white'}
        ${isMenuOpen ? '' : 'hidden md:block'}`}
    >
  <div className="flex-1 flex flex-col min-h-0 overflow-y-auto pb-24">
        <div className='w-full flex justify-center mt-4 mb-2'>
          <img
            src={assets.logo_large}
            alt="Logo"
            className='w-36 md:w-48 h-auto object-contain'
          />
        </div>
        <button 
          className='flex items-center justify-center w-full p-3 mt-4 mx-auto text-white bg-gradient-to-r from-[#A456F7] to-[#3D81F6] text-base rounded-lg shadow-md cursor-pointer'
        >
          <span className='mr-2 text-xl'>+</span> New Chat
        </button>
