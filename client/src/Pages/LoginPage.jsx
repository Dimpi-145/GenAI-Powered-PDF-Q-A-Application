...
const LoginPage = () => {
    ...
    return (
        <div
            className={`fixed inset-0 flex flex-col items-center justify-center z-50 overflow-auto min-h-screen transition-colors duration-300
                ${theme === 'dark'
        ...
        >
            ...
            <div className="w-full min-h-screen flex items-center justify-center mt-16 md:mt-24">
                <form
                    onSubmit={handleSubmit}
                    className={`flex flex-col gap-8 items-center justify-center w-full h-full max-w-md md:h-auto mx-auto p-4 md:p-10 rounded-3xl shadow-2xl border-4 animate-fade-in transition-colors duration-300
                        ${theme === 'dark'
                            ? 'bg-gray-900/95 border-gray-700 text-white'
                            : 'bg-white/95 border-white/60 text-gray-900'}
                    `}
                >
                    <h1 className={`text-4xl font-extrabold text-center drop-shadow-lg mb-2
                        ${theme === 'dark'
                    ...
                    <p className={`text-lg mb-4 text-center ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>Sign in to your account or create a new one below.</p>
                    <button
                        type="button"
                        className={`flex items-center gap-3 w-full justify-center py-3 px-6 rounded-lg border-2 transition-all shadow-md mb-2 font-semibold text-base
                            ${theme === 'dark'
                    ...
                    {state === "register" && (
                        <div className="w-full flex flex-col items-center">
                            ...
                            <input onChange={(e) => setName(e.target.value)} value={name} placeholder="Type your name" className={`border-2 rounded-lg w-full p-3 mt-1 outline-none transition-colors duration-200
                    ...
                    <div className="w-full flex flex-col items-center">
                        ...
                        <input onChange={(e) => setEmail(e.target.value)} value={email} placeholder="Type your email" className={`border-2 rounded-lg w-full p-3 mt-1 outline-none transition-colors duration-200
                    ...
                    <div className="w-full flex flex-col items-center">
                        ...
                        <input onChange={(e) => setPassword(e.target.value)} value={password} placeholder="Type your password" className={`border-2 rounded-lg w-full p-3 mt-1 outline-none transition-colors duration-200
                    ...
                    <button type='submit' className={`w-full py-3 rounded-lg font-bold text-lg shadow-lg mt-2 transition-all
                        ${theme === 'dark'
