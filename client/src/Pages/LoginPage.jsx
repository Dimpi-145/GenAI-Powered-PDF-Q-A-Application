...
const LoginPage = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen w-full bg-gradient-to-b from-[#242124] to-[#000000]">
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 items-start p-8 py-12 w-80 sm:w-[352px] text-gray-500 rounded-lg shadow-xl border border-gray-200 bg-white">
